...
return [
    ...
    'features'   => [
        ...
        [
            'en' => ['title' => 'Bulk import', 'desc' => 'Import or update locations from CSV on WooCommerce > Lokilo Import instead of adding each store by hand.'],
            'pl' => ['title' => 'Import zbiorczy', 'desc' => 'Importuj lub aktualizuj lokalizacje z pliku CSV na ekranie WooCommerce > Lokilo Import.'],
        ],
    ],
];
