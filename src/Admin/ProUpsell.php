...
final class ProUpsell
{
    ...
    private function priceLabel(): string
    {
        ...
        if (! empty($d['price_from'])) {
            ...
            return sprintf(__('from %1$s%2$d/yr', 'lokilo'), $cur, (int) $d['price_from']);
        }
        return '';
    }
    ...
    public function handleDismiss(): void
    {
        if (! current_user_can('manage_woocommerce')) {
            wp_die(esc_html__('Permission denied.', 'lokilo'));
        }
    ...
    public function banner(): void
    {
        ...
        $name     = (string) ($this->data()['name'] ?? 'Lokilo Pro');
        ...
        <div class="locator-pro-banner" role="note">
            ...
            <p class="locator-pro-banner__text">
                ...
                printf(esc_html__('Do more with %s', 'lokilo'), esc_html($name)); ?></strong>
            ...
            <a class="locator-pro-banner__dismiss" href="<?php echo esc_url($this->dismissUrl()); ?>" aria-label="<?php esc_attr_e('Dismiss this notice', 'lokilo'); ?>">&times;</a>
        </div>
        <?php
    }
    ...
    public function aside(): void
    {
        ...
        <aside class="locator-card locator-pro-aside" aria-labelledby="locator-pro-aside-h">
            ...
            <h2 id="locator-pro-aside-h" class="locator-pro-aside__heading"><?php esc_html_e('Unlock every PRO feature', 'lokilo'); ?></h2>
            ...
            <?php if ($price !== '') : ?>
                <p class="locator-pro-aside__price"><?php echo esc_html($price); ?><?php if ($this->sellable()) : ?> · <?php esc_html_e('one licence, every PRO feature', 'lokilo'); ?><?php endif; ?></p>
            <?php endif; ?>
        </aside>
        <?php
    }
    ...
    public function cards(): void
    {
        ...
        <section class="locator-pro-cards" aria-labelledby="locator-pro-cards-h">
            <h2 id="locator-pro-cards-h" class="locator-pro-cards__title">
                <?php
                /* translators: %s: PRO edition name */
                printf(esc_html__('What %s adds', 'lokilo'), esc_html($name)); ?>
            </h2>
